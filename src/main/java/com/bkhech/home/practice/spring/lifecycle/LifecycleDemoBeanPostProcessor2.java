 ...
 * @date 2021/5/14
 */
public class LifecycleDemoBeanPostProcessor2 implements BeanPostProcessor {

    public LifecycleDemoBeanPostProcessor2() {
        System.out.println("LifecycleDemoBeanPostProcessor2 constructor");
    }
    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
        ...
        if (bean instanceof LifecycleDemo || bean instanceof LifecycleDemo2 || bean instanceof User) {
            System.out.println("LifecycleDemoBeanPostProcessor2 postProcessBeforeInitialization----" + beanName);
        }
        return bean;
    }
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        if (bean instanceof LifecycleDemo || bean instanceof LifecycleDemo2 || bean instanceof User) {
            System.out.println("LifecycleDemoBeanPostProcessor2 postProcessAfterInitialization----" + beanName);
        }
        return bean;
    }
