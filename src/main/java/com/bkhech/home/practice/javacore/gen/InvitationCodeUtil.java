package com.bkhech.home.practice.javacore.gen;
...
/**
 * 基于全局ID生成全局唯一邀请码
 * https://www.jianshu.com/p/c250ccc5fe1e
 * @author guowm
 * @date 2021/3/30
 */
public class InvitationCodeUtil {
    ...
    private static void add(Consumer<String> consumer, String element) {
        consumer.accept(element);
    }

    public static void main(String[] args) {
        String gen = InvitationCodeUtil.gen(1215L);
        System.out.println(gen);
        Long decode = InvitationCodeUtil.decode(gen);
